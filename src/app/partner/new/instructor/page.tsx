...
import { StateSchema, InstructorCreateRequestPayload } from "@/app/api/schema";
...
export default function EmployeePage() {
  ...
  const mutation = trpc.createInstructor.useMutation({
    onSuccess: () => { route.back() }
  })

  const form = useForm<InstructorCreateRequestPayload>({
    resolver: zodResolver(InstructorCreateRequestPayload),
    defaultValues: {
      username: "",
      password: "",
  ...
  const onSubmit: SubmitHandler<InstructorCreateRequestPayload> = (data) => {
  ...
  return (
    <AdminLayout>
      <div className="space-y-6 p-6">
        <div>
          <h3 className="text-lg font-medium">Cadastro de Instructoro</h3>
        </div>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Curso de formação</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  <FormLabel>Graduado em</FormLabel>
                  <Popover>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
